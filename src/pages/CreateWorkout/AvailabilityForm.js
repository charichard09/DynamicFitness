  ...
  return (
    <React.Fragment>
      <div className="h-screen">
        <h3 className="pl-2 text-2xl font-bold">What is your availability?</h3>
        <div className="border-4 border-black bg-white pl-3 p-1 pb-2 mt-2 mb-10 m-5 flex-col h-auto" >
          ...
          <div className="flex justify-between">
            <button type="button" className="bg-slate-900 hover:bg-slate-700 text-white font-bold py-1 px-4 mt-4 mb-1 ml-3 rounded" onClick={() => props.onClickingFormNavigation("equipment")}>
            ...
            <button type="button" className="bg-slate-900 hover:bg-slate-700 text-white font-bold py-1 mr-3 px-4 mt-4 mb-1 ml-3 rounded" onClick={() => props.onClickingFormNavigation("reviewWorkout")} hidden={showNextButton}>
              Next
