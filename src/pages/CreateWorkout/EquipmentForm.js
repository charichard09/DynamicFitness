  ...
  return (
    <React.Fragment>
      ...
      <div className="border-4 border-black bg-white pl-3 p-1 pb-2 mt-2 mb-10 m-5 flex-col h-auto" >
        ...
        <button type="button" className="bg-slate-500 hover:bg-slate-700 text-white font-bold py-1 px-4 mt-4 mb-1 ml-3 rounded" onClick={() => props.onClickingFormNavigation("goals")}>
        ...
        <button type="button" className="bg-slate-500 hover:bg-slate-700 text-white font-bold py-1 px-4 mt-4 mb-1 ml-3 rounded" onClick={() => props.onClickingFormNavigation("availability")} hidden={showNextButton}>
          Next
